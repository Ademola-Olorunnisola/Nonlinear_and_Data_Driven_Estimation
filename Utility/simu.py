...
Original file is located at
    https://colab.research.google.com/drive/1CvkCGnZQUp2ReCx4rlp2UFfrm7UfHn70
"""
...
class F(object):
    ...
    def f(self, x_vec, u_vec, Lambda=Lambda, mu=mu, gamma=gamma, return_state_names=False):
        ...
        # Combine everything
        x_dot_vec = np.concatenate([
            svir_dynamics[:4],  # S, V, I, R dynamics
            [beta_dot, sigma_dot]  # Parameter dynamics
        ])
